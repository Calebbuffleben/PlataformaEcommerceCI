...
class Pedidos_model extends CI_Model {
    ...
    public function estatisticas() {
        $consulta = "SELECT count(*) as quantos FROM pedidos WHERE status = 0 UNION ALL SELECT count(*) as quantos FROM pedidos"
                . " WHERE status = 1 UNION ALL SELECT count(*) as quantos FROM pedidos WHERE status = 2";
    ...
    public function alterar_pedido($id,$status,$comentarios){
        $dados['status'] = $status;
