...
echo "<div class='row-fluid'>" .
 "<div class='span9'>" . form_submit("btnAtualizar", "Atualizar quantidades") .
 "</div>" .
 "<div class='span1 texto-direita'>" . reais($this->cart->total()) . "</div>" .
 "</div>" .
 form_close();
if ($frete) {
    ...
    "<div class='span1 texto-direita'>" . reais($frete) . "</div>" .
